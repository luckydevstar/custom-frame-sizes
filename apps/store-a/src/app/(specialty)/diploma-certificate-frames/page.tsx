            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none space-y-4 text-muted-foreground">
                ...
                <p>
                  ...
                  (8 1/4 × 11 3/4 inches) for standard degrees and A3 format (11 3/4 × 16 1/2 inches) for
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  ...
                  including A4 (8 1/4 × 11 3/4 inches) and A3 (11 3/4 × 16 1/2 inches) for European and
                  global universities.
                </p>
              </div>
              <div
