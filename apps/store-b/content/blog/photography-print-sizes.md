---
title: "Photography Print Sizes: Standard Dimensions and How to Crop for Framing"
description: Master photography print sizes and aspect ratios. Learn standard photo sizes, how to crop for frames, and avoid common printing mistakes for perfect framed photos.
slug: photography-print-sizes
date: 2024-08-28
tags: ["photography", "sizing", "printing"]
author: ShadowboxFrames Team
hero: /images/blog/photography-print-sizes-lifestyle-hero.png
---

Every camera shoots at a specific aspect ratio, and those ratios don't always match standard print sizes. If you've ever cropped a photo to 8×10 and lost important detail on the sides, that's why. Understanding the relationship between aspect ratios and print sizes helps you choose the right frame without sacrificing parts of the image.
...
**How it works**:
1. Order print in your camera's native ratio (12×18)
2. Buy larger frame (16×20)
3. Use mat with 12×18 opening
4. Mat fills the extra space beautifully

This approach preserves your entire image while using standard, affordable frame sizes. Learn more in our [mat board guide](/mat-board-guide).
...
**How to check**:
1. Find your image dimensions in pixels (e.g., 6000×4000)
2. Divide by desired print size
3. Example: 6000 pixels ÷ 20 inches = 300 DPI ✓ (excellent)
...
- See our [gallery wall layouts](/blog/gallery-wall-layouts) for ideas
...
1. **Select "Do Not Crop" if available**: Gives you control over composition
2. **Review preview carefully**: Most services show what will be cropped
3. **Order test print first**: For important photos, order one print to verify quality
4. **Choose right paper**: Glossy for vibrant colors, matte for portraits
5. **Use reputable services**: Mpix, Nations Photo Lab, or Printique for quality
...
Enter your print dimensions in the [frame designer](/) to see frame options with real-time pricing. If your print size is non-standard, that's fine. We cut to any dimension.
