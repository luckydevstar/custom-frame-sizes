...
import { Check, ChevronDown, ChevronUp, Package, ShoppingCart, X } from "lucide-react";
...
export function SamplesPageContent() {
  ...
  const productSchema = {
    ...
    description:
      "Order samples of our custom shadow box frames, mat boards, and acrylic glazing options. Frame samples are 4-inch pieces ($5 each), mat and acrylic samples are 2x2-inch pieces ($3 each).",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "How is shipping handled for sample orders?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Shipping rates for sample orders are calculated at checkout based on destination. Samples typically arrive within 3-5 business days.",
        },
      },
      {
        "@type": "Question",
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.shadowboxframes.com" },
      {
        "@type": "ListItem",
        position: 2,
        name: "Samples",
        item: "https://www.shadowboxframes.com/samples",
      },
    ],
  };
      ...
      <div className="container mx-auto px-4 py-8 max-w-screen-xl pb-32">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold mb-4" data-testid="text-page-title">
            Order Shadow Box Samples
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
            Choosing a shadow box frame is a personal decision, and we want you to feel confident in every detail.
            Order frame corner samples and mat board swatches so you can see our materials in your own space, hold them
            next to your keepsake, and know exactly what your finished shadow box will look and feel like.
          </p>
          <div className="inline-flex items-center gap-2 bg-muted/50 px-4 py-2 rounded-full">
            <Package className="w-5 h-5" />
            <span className="font-medium">See and Touch Our Materials Before You Decide</span>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-6">
            Our frame corner samples are actual pieces of the moulding profiles we use in our shadow boxes. Each sample
            shows you the true color, texture, grain, and finish of the frame so there are no surprises when your shadow
            box arrives. Hold a sample next to your keepsake, see how it looks against your wall color, and choose with
            total confidence. We offer samples across our full range of wood tones, painted finishes, and metallic
            profiles.
          </p>
          ...
          {framesByCategory.shadowbox.length > 0 && (
            ...
            >
              <CollapsibleTrigger asChild>
                ...
                >
                  <span className="flex items-center gap-2">
                    <span className="font-semibold">Shadow Box Frames</span>
        ...
        <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-6">
            The backing and mat colors inside your shadow box set the stage for your keepsake. Our swatch kits include a
            curated selection of our most popular acid-free mat boards and backing materials so you can compare shades,
            textures, and tones side by side. Pair them with your frame corner sample to see the full picture before
            placing your order.
          </p>
        ...
        {/* FAQ Section for SEO */}
        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-6">Questions we hear most</h2>
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">How is shipping handled for sample orders?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Shipping rates for sample orders are calculated at checkout based on destination. Samples typically
