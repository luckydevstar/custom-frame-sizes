...
export const CERTIFICATE_SIZES: CertificateSize[] = [
  ...
  },
  {
    ...
    frameWidth: 14,
    frameHeight: 11,
    notes: "A4 paper size (297×210mm) rounded to nearest 1/8\"; landscape orientation",
    displayName: 'A4 Landscape (11 3/4" × 8 1/4")',
  },
  {
    id: "license-standard",
  ...
  },
  {
    ...
    documentWidth: 8.25,
    documentHeight: 11.75,
    frameWidth: 11,
    frameHeight: 14,
    notes: "A4 paper size (210×297mm) rounded to nearest 1/8\"; portrait orientation",
    displayName: 'A4 Portrait (8 1/4" × 11 3/4")',
  },
  {
    id: "license-portrait",
    category: "Professional License",
